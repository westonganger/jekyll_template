...
group :jekyll_plugins do
  ...
  ### Data Plugins
  gem "jekyll-manager" # fork of jekyll-admin, https://ashmaroli.github.io/jekyll-manager/
  #gem 'jekyll-data' # Not needed with jekyll-manager, Read '_config.yml' and data files within Jekyll theme gems, https://github.com/ashmaroli/jekyll-data
  ...
  ### Ungemified
  #ungemified 'jekyll-gallery-tag' # https://github.com/martinruenz/JekyllGalleryTag - should gemify, add masonry option
